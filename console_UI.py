        ...
        while True:
            ...
            if choice == '1':
                ...
                try:
                    ...
                    self.model_tester = ModelTester(loader._df)
                ...
                if self.model_tester:
                    try:
                        ...
                        sample_dict = {}
                        features = list(self.model_tester._model._x.values())[0].keys()
                        for feature in features:
                            possible_values = list(list(self.model_tester._model._x.values())[0][feature].keys())
                        ...
                        result = self.model_tester._model.predict(sample_dict)
